...
qFALL-tools offers a variety of implementations of cryptographic primitives.
...
Please use the following bibtex entry to cite [qFALL-tools](https://github.com/qfall/crypto):
